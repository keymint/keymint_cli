...
from keymint_cli.command import get_command_extensions


def main(*, script_name='keymint', argv=None, description=None, extension=None):
    if description is None:
        description = '{script_name} is an extensible command-line tool for ' \
            'keymint.'.format_map(locals())
    ...
    if extension:
        ...
        extensions = get_command_extensions('keymint_cli.command')
